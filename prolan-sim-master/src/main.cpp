...
int main(int argc, char** argv)
{
	...
	vector<mataKuliah>::iterator iMK;
	...
	while(1) 
	{
		...
		cout << "  4. Jumlah Mata Kuliah		: \033[32m" << recMatkul.size() << " Matkul Terdaftar\033[0m" << endl;
		cout << endl;
		...
		{	
			...
			case 4://Menambah Mata Kuliah
				{
					string matkul;
					int id = 0;
					cout << "\033[1mMASUKKAN MATA KULIAH" << endl;
					cout << "------------------------------------\033[0m\n" << endl;
					cout << "Nama	: ";
					cin.ignore();
					getline(cin,matkul);
					cout << endl;
					recMatkul.push_back(mataKuliah(id, matkul));

					int menu;
					cout << "\033[1m\nMenu\033[0m" <<endl;
					cout << " 1. Pilih Dosen Pengampu" <<endl;
					...
					switch (menu)
					{
						case 1://Daftarkan Dosen Pengampu untuk Mata Kuliah
							{
								system("CLS");
								...
								else
								{
									...
									cout << "\033[1mPilih nomor data Dosen: ";
									cin >> pilihan;
									cout << "\033[0m" <<endl;
									if(pilihan > recDosen.size())//Error Notice
									{
									...
									{
										ListDosen temp;
										temp.nama = recDosen[pilihan - 1].getNama();
										temp.departemen = recDosen[pilihan - 1].getDepartemen();
										recMatkul[jumlah_matkul].setdataDosen(temp);	
									}
								}
							}
							break;

						case 0://Keluar Opsi Mata Kuliah
							{
								system("CLS");
								break;
							}
			...
			case 5://Menampilkan Data Mahasiswa
				{
			...
			case 7://Menampilkan Data Tendik
				{
			...
			case 8://Tampilkan Daftar Matkul
				{
					cout << "\033[1m[DATA MATA KULIAH]\033[0m" <<endl <<endl;
					if(recMatkul.size() == 0)//Error Notice
					{
						cout << "\033[3;31m~Tidak Ada Data Mata Kuliah~\033[0m\n" <<endl;
					...
					else//Menampilkan Seluruh Data Matkul
					{
						while(1)
						{
							for(unsigned i=0; i < recMatkul.size(); i++)
							{
								cout << "\033[1;32m" << i + 1 << "]\033[0m";
								cout << "\033[1m -----------------------------------------------\033[0m" <<endl;
								cout << recMatkul[i].getMatkul() <<endl;
								cout << "Dosen Pengampu: "; 
								cout << (recMatkul[i].getdataDosen())[0].nama;
								cout << "(" << (recMatkul[i].getdataDosen())[0].departemen << ")" <<endl;
								cout << endl;

								if (recMatkul[i].getId() == 0)
								{
									cout << "Belum ada Mahasiswa yang terdaftar" <<endl;
								}
								else
								{
									for(int j=0; j < recMatkul[i].getId(); j++)
									{
										cout << "	Mahasiswa " << j+1 <<endl;
										cout << "		Nama		: " << (recMatkul[i].getdataMhs())[j].nama <<endl;
										cout << "		NRP		: " << (recMatkul[i].getdataMhs())[j].nrp <<endl;
										cout << "		Departemen	: " << (recMatkul[i].getdataMhs())[j].departemen <<endl;
										cout << "		Tahun Masuk	: " << (recMatkul[i].getdataMhs())[j].tahunmasuk <<endl;
										cout << endl;
									}
								}
								cout << endl;
							...
							switch (menu)//Edit Data
							{
								case 1://Edit Data Matkul
									{
										...
										cout << "\033[1;32m" << pilihan << "]\033[0m";
										cout << "\033[1m -----------------------------------------------\033[0m" <<endl;
										cout << recMatkul[pilihan - 1].getMatkul() <<endl;
										cout << "Dosen Pengampu: "; 
										cout << (recMatkul[pilihan - 1].getdataDosen())[0].nama;
										cout << "(" << (recMatkul[pilihan - 1].getdataDosen())[0].departemen << ")" <<endl;
										cout << endl;

										if (recMatkul[pilihan - 1].getId() == 0)
										{
											cout << "Belum ada Mahasiswa yang terdaftar" <<endl;
										}
										else
										{
											for(int j=0; j < recMatkul[pilihan - 1].getId(); j++)
											{
												cout << "	Mahasiswa " << j+1 <<endl;
												cout << "		Nama		: " << (recMatkul[pilihan - 1].getdataMhs())[j].nama <<endl;
												cout << "		NRP		: " << (recMatkul[pilihan - 1].getdataMhs())[j].nrp <<endl;
												cout << "		Departemen	: " << (recMatkul[pilihan - 1].getdataMhs())[j].departemen <<endl;
												cout << "		Tahun Masuk	: " << (recMatkul[pilihan - 1].getdataMhs())[j].tahunmasuk <<endl;
												cout << endl;
											}
										}
										cout << endl;
										...
										cout << "Opsi Pengeditan Data\033[0m" <<endl;
										cout << " 1. Edit Dosen Pengampu" <<endl;
										cout << " 2. Tambah Mahasiswa Terdaftar" <<endl;
										cout << " 0. \033[3mKembali\033[0m" <<endl;
										cout << "\033[1m-> Pilih Opsi: ";
										cin >> opsi;
										cout << "\033[0m" <<endl;
										switch (opsi)
										{
											case 1://Edit Dosen Pengampu
												{
													...
													long long unsigned nomor;
													cout << "\033[1mPilih nomor data Dosen: ";
													cin >> nomor;
													cout << "\033[0m" <<endl;
													if(nomor > recDosen.size())//Error Notice
													{
														cout << "\033[1;31m-ERROR- \033[3;21mUnmatch Data Input!\033[0m" << endl;
													...
													{
														ListDosen temp;
														temp.nama = recDosen[nomor - 1].getNama();
														temp.departemen = recDosen[nomor - 1].getDepartemen();
														recMatkul[pilihan - 1].setdataDosen(temp);

														break;
													}
												}

											case 2://Menambah Mahasiswa pada Mata Kuliah
												{
													for(unsigned i=0; i < recMhs.size(); i++)
													{
														cout << "\033[1;32m" << i + 1 << "]\033[0m";
													...
													long long unsigned nomor;
													//int id = 0;
													cout << "\033[1mPilih nomor data Mahasiswa: ";
													cin >> nomor;
													cout << "\033[0m" <<endl;
													if(nomor > recMhs.size())//Error Notice
													{
														cout << "\033[1;31m-ERROR- \033[3;21mUnmatch Data Input!\033[0m" << endl;
													...
													{
														ListMhs temp;
														temp.nama = recMhs[nomor - 1].getNama();
														temp.nrp = recMhs[nomor - 1].getNRP();
														temp.departemen = recMhs[nomor - 1].getDepartemen();
														temp.tahunmasuk = recMhs[nomor - 1].getTahunMasuk();
														recMatkul[pilihan - 1].setdataMhs(temp);

														int id = recMatkul[pilihan - 1].getId();
														int new_Id = id + 1;
														recMatkul[pilihan - 1].setId(new_Id);
											...
											case 0://Keluar Matkul Data Editor
												{
													break;
												}
										}
								...
								case 0://Keluar Tampilan Data Matkul
									{
										break;
									}
